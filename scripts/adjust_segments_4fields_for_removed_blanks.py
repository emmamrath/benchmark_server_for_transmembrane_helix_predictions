...
# python adjust_segments_4fields_for_removed_blanks.py test1.fasta.split4 test1.leading_blanks_removed test1.fasta.split4.adjusted_for_removed_blanks

# python adjust_segments_4fields_for_removed_blanks.py [input-file] [input-file-2] [output-file]
	...
	for inline in inlines1:
		...
		if (inline != ''):
			...
			if (this_num_removed == -1):
				...
				output_line = this_id + ':::::' + this_seq + ':::::' + this_segments + ':::::' + this_field4 + ':::::' + "\r\n"
				new_seq = ''
				if (this_num_removed > 0):
					...
					if (new_segments == ''):
						new_segments = '-'
					output_line = this_id + ':::::' + new_seq + ':::::' + new_segments + ':::::' + this_field4 + ':::::' + "\r\n"
