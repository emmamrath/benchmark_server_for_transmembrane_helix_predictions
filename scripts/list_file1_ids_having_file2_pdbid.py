...
# python list_file1_ids_having_file2_pdbid.py opm_feb2012.all_opm.opm_seq possible_wrong_upper_chains_in_pdb_struc2D need_to_redo_pdb_struc2D_for_lowercase

# python list_file1_ids_having_file2_pdbid.py [input-file-1] [input-file-2] [output-file]
