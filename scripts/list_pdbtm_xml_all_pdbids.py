...
# python ../list_pdbtm_xml_all_pdbids.py pdbtmalpha___PDBTM_feb2012_all_helical_transmembrane_proteins.xml pdbtm_pdbids_from_pdbtmalpha
# python ../list_pdbtm_xml_all_pdbids.py pdbtmbeta___PDBTM_feb2012_all_beta_barrel_transmembrane_proteins.xml pdbtm_pdbids_from_pdbtmbeta

# python list_pdbtm_xml_all_pdbids.py [input-file] [output-file]
...
def handle_chain( pdbtm_ID, chain ):
	...
	output_line = pdbtm_ID + '_' + pdbtm_chain_CHAINID + "\r\n"
