...
# python ../remove_HHH.py opm_feb2012.list2c_from_pdb_seq.pdb_seq opm_feb2012.list2e_from_pdb_seq.pdb_seq
...
def remove_HHHHHH( this_seq ):
	...
	if ( len_this_seq >= 3 ):
		last_6_residues = new_seq[ (len_this_seq-3) : len_this_seq ]
		if ( last_6_residues == 'HHH' ):
			new_seq = ''
			in_HHHHHH = 1
