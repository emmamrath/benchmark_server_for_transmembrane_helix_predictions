...
# python add_field3_seq_to_records.py alpha_polytopic_bitopic_noblanks.fasta.membrain.adjusted_for_removed_blanks alpha_polytopic_bitopic.pdb_seq alpha_polytopic_bitopic_noblanks.fasta.membrain.adjusted_for_removed_blanks.with_seq

# python add_field3_seq_to_records.py [input-file] [input-file-2] [output-file]
