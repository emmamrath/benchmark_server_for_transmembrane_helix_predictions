...
# python parse_mempype_ensemble_list_pending.py alpha_mempype_tCagy082.txt alpha_mempype_tCagy082.memtype_pending

# python parse_mempype_ensemble_list_pending.py [input-file] [output-file]
...
def main():
	...
	for inline in inlines1:
		inline = inline.strip()
		if (inline != ''):
			if ( inline.find('Prediction status: in processing queue') > -1 ):
