...
# python read_pdb_releasedate_for_list.py opm_feb2012.all_opm.opm_seq opm_feb2012.all_opm.release_date

# python read_pdb_releasedate_for_list.py [input-file] [output-file]
