...
# python list_ids_in_file1_not_in_file2.py opm_feb2012.all_opm.pdb_seq ../pdbtm_feb2012.all_pdbtm.TMH in_pdb_opm_not_in_pdbtm.txt
# python list_ids_in_file1_not_in_file2.py ../pdbtm_feb2012.all_pdbtm.TMH opm_feb2012.all_opm.pdb_seq in_pdbtm_not_in_pdb_opm.txt
...
def main():
	...
	for inline in inlines1:
		...
		if (inline != ''):
			...
			if (found_id == 0):
				#output_line = 'ID NOT FOUND : ' + this_id + "\r\n"
				output_line = this_id + "\r\n"
