...
# python adjust_segments_field4_for_removed_blanks.py test1.fasta.split4 test1.leading_blanks_removed test1.fasta.split4.adjusted_for_removed_blanks

# python adjust_segments_field4_for_removed_blanks.py [input-file] [input-file-2] [output-file]
		...
		if (inline != ''):
			...
			if (this_num_removed == -1):
				...
				if (this_num_removed > 0):
					...
					if (new_segments == ''):
						new_segments = '-'
					output_line = this_id + ':::::' + new_seq + ':::::' + new_segments + ':::::' + "\r\n"
