...
# python ../remove_file_contents_if_in_id_list.py opm_feb2012.list2a_from_pdb_seq.pdb_seq opm_feb2012.list2b_XX.pdb_seq opm_feb2012.list2c_from_pdb_seq.pdb_seq

# python remove_file_contents_if_in_id_list.py [input-file-1] [input-file-2] [output-file]
