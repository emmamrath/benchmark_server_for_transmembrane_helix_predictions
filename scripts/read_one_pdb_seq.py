...
# python read_one_pdb_seq.py 1bl8_A 1bl8_A.pdb_seq

# python read_one_pdb_seq.py [input-pdbid-and-chain] [output-append-file-for-sequences]
...
######################################################
def get_pdb_seq( input_id, server ):
...
######################################################
def write_output_seq( output_line, output_file_name ):
...
def main():
	...
	output_line = get_pdb_seq( input_id, server )

	write_output_seq( output_line, output_file_name_seq )
