...
# python adjust_segments_for_removed_blanks.py test1.fasta.split4 test1.leading_blanks_removed test1.fasta.split4.adjusted_for_removed_blanks

# python adjust_segments_for_removed_blanks.py [input-file] [input-file-2] [output-file]
