...
# python expand_segments_field4_as_MMMMMM_seq_min_length.py 10 alpha_polytopic_bitopic_noblanks.1line.pepinfo_segments.pepinfo_kyte_7_0.adjusted_for_removed_blanks alpha_polytopic_bitopic.pepinfo_kyte_7_10

# python expand_segments_field4_as_MMMMMM_seq_min_length.py [min-length] [input-file] [output-file]
