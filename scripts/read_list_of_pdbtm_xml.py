...
# python read_list_of_pdbtm_xml.py pdbtm_manual_tmh_list.pdbid pdbtm_manual_tmh_list.pdbtm_segments

# python read_list_of_pdbtm_xml.py [input-file] [output-file]
...
######################################################
def handle_all_PDBTM( all_PDBTM, pdbid ):
	#PDBTM = all_PDBTM.getElementsByTagName("PDBTM")[0]
	#each_pdbtm = PDBTM.getElementsByTagName("pdbtm")
	this_pdbtm = all_PDBTM.getElementsByTagName("pdbtm")[0]
	#for pdbtm in each_pdbtm:
	handle_pdbtm( this_pdbtm, pdbid )
	return

######################################################
def handle_pdbtm( pdbtm, pdbid ):
...
def main():
	...
	for inline in inlines:
		...
		if (inline != ''):
			...
			handle_all_PDBTM( dom, this_pdbid )
