...
# python ../display_not_equal_seqs_for_non_missing_residues.py alpha_polytopic_bitopic_peptide.opm_seq.sorted alpha_polytopic_bitopic_peptide.renum_pdb_seq alpha_polytopic_bitopic_peptide.opm_seq_not_equal_renum_pdb_seq_for_non_missing_residues.display

# python display_not_equal_seqs_for_non_missing_residues.py [input-file-1] [input-file-2] [output-file]
