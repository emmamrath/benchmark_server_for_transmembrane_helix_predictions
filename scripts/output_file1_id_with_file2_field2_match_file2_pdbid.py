...
# python ../output_file1_id_with_file2_field2_match_file2_pdbid.py list11_in_mpstruc_pass1.id mpstruc_feb2012.mpstruc_category list11_in_mpstruc_pass1.mpstruc_category

# python output_file1_id_with_file2_field2_match_file2_pdbid.py [input-file-1] [input-file-2] [output-file]
